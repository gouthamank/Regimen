...
object UnitConverter {
    ...
    fun weightLabel(system: UnitSystem): String = if (system == UnitSystem.METRIC) "kg" else "lb"
    fun distanceLabel(system: UnitSystem): String = if (system == UnitSystem.METRIC) "km" else "mi"
